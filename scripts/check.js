...
const jsFiles = [
  ...
  'js/modes/sniper-range.js', 'js/modes/tower-defense.js'
];
...
const expected = ['horde', 'zombie', 'shooters', 'medkits', 'variants', 'leaderboard', 'stickmanisland', 'dronedrive', 'jetside', 'roflcopter', 'stickinvaders', 'platform', 'sticktetris', 'waves', 'sniperrange', 'towerdefense'];
